...
<div class="col-sm-6" style="margin-top:2%">
  <form method="post" action="insurance.php" name="search_form" id="search_form">
...
if($_POST['search_text'] != '' || ($_POST['date11'] != '' && $_POST['date22'] != '')){
        ...
        $url_data = 'https://vanisha-honda.herokuapp.com/search_insurance/?access_token=YbZtBg6XuWWbZ39R3BIn9Mb1XOn7uy&page='.$page;
        $options_data = array(
          'http' => array(
            'header'  => $header,
            'method'  => 'GET',
