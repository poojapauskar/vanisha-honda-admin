...
<div class="container">
  <div class="row" id="row1" style="margin: auto;background-color:#607D8B;margin-top:15%;height:80px;">
    ...
    <div class="col-sm-1" style="margin-top:3%;">
      <h6 style="margin-top:0%;">Bookings</h6>
    </div>
...
<div class="col-sm-6" style="margin-top:2%">
  <form method="post" action="bookings.php" name="search_form" id="search_form">
...
if($_POST['search_text'] != '' || ($_POST['date11'] != '' && $_POST['date22'] != '')){
        ...
        $url_data = 'https://vanisha-honda.herokuapp.com/search_bookings/?access_token=YbZtBg6XuWWbZ39R3BIn9Mb1XOn7uy&page='.$page;
        $options_data = array(
          'http' => array(
            'header'  => $header,
            'method'  => 'GET',
        ...
        $bookings_info = json_decode($output_data,true);

}else{
        
        $url_data = 'https://vanisha-honda.herokuapp.com/get_all_bookings/?access_token=YbZtBg6XuWWbZ39R3BIn9Mb1XOn7uy&page='.$page;
        $options_data = array(
          'http' => array(
...
<table id="example" align="center" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp results">
  ...
  <tbody>
   <?php 
      for ($x = 0; $x < count($bookings_info['response']); $x++) { ?>
              <tr>
                <td align="left"><?php echo empty($bookings_info['response'][$x]['booking_details']['quotation']) ? "NULL" : $bookings_info['response'][$x]['booking_details']['quotation']; ?></td>
                <td align="left"><?php echo empty($bookings_info['response'][$x]['user_details']['name']) ? "NULL" : $bookings_info['response'][$x]['user_details']['name']; ?></td>
                <td align="left"><?php echo empty($bookings_info['response'][$x]['user_details']['mobile']) ? "NULL" : $bookings_info['response'][$x]['user_details']['mobile']; ?></td>
                <td align="left"><?php echo empty($bookings_info['response'][$x]['user_details']['email']) ? "NULL" : $bookings_info['response'][$x]['user_details']['email']; ?></td>
                <td align="left"><?php echo empty($bookings_info['response'][$x]['vehicle_details']['vehicle']) ? "NULL" : $bookings_info['response'][$x]['vehicle_details']['vehicle']; ?></td>
                <td align="left"><?php echo empty($bookings_info['response'][$x]['vehicle_details']['colour']) ? "NULL" : $bookings_info['response'][$x]['vehicle_details']['colour']; ?></td>
                ...
                <td style="text-overflow:initial;overflow:initial;white-space:initial;" align="left"><?php echo empty($bookings_info['response'][$x]['booking_details']['delivery_date']) ? "NULL" : $bookings_info['response'][$x]['booking_details']['delivery_date']; ?></td>
...
<div style="text-align:center">
  <ul class="pagination"  style="overflow-x:auto;overflow-y:hidden;max-width:239px;">
      ...
      <table>
          <tr>
            <?php 
                for ($x = 0; $x <= $bookings_info['count']/10; $x++) { ?>
                    <td>
