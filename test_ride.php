...
<div class="container">
  <div class="row" id="row1" style="margin: auto;background-color:#607D8B;height:80px;">
    ...
    <div class="col-sm-1" style="margin-top:3%;">
      <h6 style="margin-top:0%;">Test Ride</h6>
    </div>
...
<div class="col-sm-6" style="margin-top:2%">
  <form method="post" action="test_ride.php" name="search_form" id="search_form">
...
if($_POST['search_text'] != '' || ($_POST['date11'] != '' && $_POST['date22'] != '')){
        ...
        $test_rides_info = json_decode($output_data,true);

}else{
      
        $url_data = 'https://vanisha-honda.herokuapp.com/get_all_test_rides/?access_token=YbZtBg6XuWWbZ39R3BIn9Mb1XOn7uy&page='.$page;
        $options_data = array(
          'http' => array(
