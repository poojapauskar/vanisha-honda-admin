...
if($_POST['search_text'] != '' || ($_POST['date11'] != '' && $_POST['date22'] != '')){
        ...
        $url_data = 'https://vanisha-honda.herokuapp.com/search_inventory/?access_token=YbZtBg6XuWWbZ39R3BIn9Mb1XOn7uy&page='.$page;
        $options_data = array(
          'http' => array(
            'header'  => $header,
            'method'  => 'GET',
      ...
      $url_data = 'https://vanisha-honda.herokuapp.com/get_all_inventory/?access_token=YbZtBg6XuWWbZ39R3BIn9Mb1XOn7uy&page='.$page;
      $options_data = array(
        'http' => array(
